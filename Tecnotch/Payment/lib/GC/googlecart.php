...
//          $ShippingPackage = $ship->ShippingPackage;
    ...
    function CheckoutButtonCode($size="large", $variant=true, $loc="en_US",
      ...
      $data = "<div>";
      if ($this->variant == "text") {
        $data .= "<div align=center><form method=\"POST\" id=\"google_form\" action=\"". 
			...
			google checkout within 5 seconds...<br/><br/>\n
    ...
    function CheckoutButtonCodeOrg($size="large", $variant=true, $loc="en_US",
                                               $showtext=true, $style="trans") {
